...
const Necessities = () => {
  return (
    <div className="bg-bg-off flex flex-col justify-center items-center pt-24">
      <div>
        <h3 className="font-header font-bold text-primary-b text-center text-4xl after:content-[url('./assets/TwoPlanes.png')] after:block after:absolute after:right-56">
