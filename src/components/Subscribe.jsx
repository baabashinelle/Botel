...
const Subscribe = () => {
  return (
    <section className="flex flex-col justify-center items-center -mb-[11rem] pt-24 bg-bg-c font-text">
      <div className="w-fit bg-primary-o py-24 md:px-[14rem] rounded-lg relative overflow-hidden before:content-[url('./assets/trees-white.png')] before:block before:absolute before:right-0 before:top-[0.5rem] after:bg-[url('./assets/circles.png')] after:bg-no-repeat after:bg-[length:24rem] after:w-full after:h-full after:block after:absolute after:top-20 after:left-0">
